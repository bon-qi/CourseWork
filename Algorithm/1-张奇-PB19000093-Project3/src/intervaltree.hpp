...
// initialization functions and comparsions of a interval
...
public:
    ...
    // initializator: default and make nil node
    IntervalTree() 
    : m_nill(new Node()), m_root(m_nill)
    {
    }

    // initialization: from anothor container
    ...
    // initialization: from anothor iterator
    ...
    // deconstractutor: delete all the new nodes
